...
The *Wappenkalender* changed during as well as between annual issues. The 1728 annual states that its 108 genealogical tables had been reviewed anew and enlarged *nach den neuesten Nachrichten* so that they could be used with *zuverlässiger Gewißheit* and *guter Bequemlichkeit* in *täglichen Zeitungs-Lesen*.[^21] The same copy ends with a page headed *Unter währenden Druck eingelauffene Zusätze und Verbesserungen*. Births, marriages, and deaths received while the book was already in press are tied to specific tables or pages.[^22]
...
The Tübingen *Synopsis* supplies the inverse case. Its title promises coloured tables, while one relevant table survives without pigment beside another that received it. Gatterer’s path through the Nürnberg publication world and into Göttingen places these cases within one publication trajectory. A black page could carry colour; a book advertised as coloured could survive without it.

---

# Figure programme

**Figure 1 — Schlözer 1772: colour at the fact layer**  
A. mosaic / *Facta färben* / *Zusammenstellung*.
...
B. Spener 1680 hatching + prose fallback.
...
**Figure 6 — Publisher retrospective, 1772**  
A. small figures.  
...
Current target: seven formal figures, c. 16 image units. Fig. 4 remains the visual centre; Figs. 7 and 2 carry the return from Nürnberg to Göttingen.

---

# Notes / source ledger

Evidence-status labels below are editorial controls rather than article prose. **PARTIAL / NOTE-ONLY** items remain outside the body until the cited primary object is directly controlled.
...
[^2]: **PARTIAL / NOTE-ONLY.** Schlözer’s reply to Herder was first issued in part II of the 1773 *Vorstellung*. The passage on *gemahlte chronologische Tabellen*, Solomon’s Temple, the Egyptian pyramids, Homer, *Synchronismus*, and *Association der Ideen* is bibliographically located but presently controlled through close secondary transcription. Do not return it to body prose or a figure until the institutional primary page is directly inspected.

[^3]: **PARTIAL / NOTE-ONLY.** Schlözer, *Vorstellung der Universal-Historie*, 2nd changed ed. (Göttingen: Dieterich, 1775), `[6] Bl., 307 S.`, VD18 `11056576`, ULB Sachsen-Anhalt `AB 22 A 9/k, 26 (1)`, DOI `10.25673/95805`. Modern scholarship reproduces the phrase *durch Illumination der Tabelle* for making unequal historical durations visible; the exact primary page remains unresolved.

[^4]: **NOTE-ONLY CONTEXT.** Schlözer, *Species Facti* (1773); Gatterer, *Antwort auf die Schlözersche Species Facti* (Göttingen: Dieterich, 1773), LMU URN `urn:nbn:de:bvb:19-epub-11937-9`. The controversy concerns teaching, priority, and alleged borrowing; current controls do not establish colour as an explicit subject of the exchange.
...
[^8]: **PARTIAL / NOTE-ONLY.** Martin Schmeitzel, *Einleitung zur Wappen-Lehre* (Jena, 1723), p. 69; later exact heraldic transcription with fixed primary locator reports *sauber in Kupfer gestochen* / *nichts werth*. Direct first-edition page remains a diplomatic upgrade.

[^9]: **NOTE-ONLY COMPARATOR.** Venator & Hanstein, catalogue 128, lot 305: Augsburg *Genealogisch-Heraldischer Staats-Kalender* 1723, described with frontispiece, 74 armorial copperplates, 12 text coppers, and folding genealogical trees.
...
[^11]: **PARTIAL / NOTE-ONLY.** Modern heraldic bibliography reports lower-case tincture letters in Siebmacher 1609. No figure or body claim until a direct plate is controlled.
...
[^35]: **PARTIAL / NOTE-ONLY BRIDGE.** Johann David Köhler, *Programma De Inventoribus Incisurarum Gallice Les Hachures Dictarum Quibus Metalla Et Colores In Tesseris Gentilitiis Absque Pigmentis Indicantur* (Göttingen: Johann Friedrich Hager, 1736). The imprint and subject are bibliographically controlled. The claimed explicit Gatterer → Köhler referral remains tied to the partial p. 12 control in note 34 and therefore stays out of body prose.

[^36]: **PARTIAL / NOTE-ONLY.** Public secondary reproductions identify Gatterer 1774, Tab. II figs. 19–20 as Rink’s signs for *Naturfarbe* and *Eisenfarbe*. Final publication use requires the institutional scan.

[^37]: Gatterer, *Von der historischen Erziehung*, 1771, modern critical edition, passage on colouring *Wappen* / *Stammbäume* and material numismatic exercises. Body prose explicitly attributes this control to the critical edition rather than claiming direct first-edition inspection.
